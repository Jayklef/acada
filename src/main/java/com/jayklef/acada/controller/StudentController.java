...
public class StudentController {
    ...
    public ResponseEntity<Student> updateStudent(@PathVariable("studentId") Long id, Student student){
        Student studentToUpdate = studentService.updateStudent(id, student);
